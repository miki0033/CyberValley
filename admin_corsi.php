...
//VARIALIBI
$titolo = "Lista Corsi - Cyber Valley";
?>
    ...
    <div class="main-panel">
      ...
      <div class="content">
        <button type="button" class="btn btn-warning btncrea">
          <a href="modifica.php?table=corsi" target='_blank' rel="noopener noreferrer">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            if (count($corsi) < 1) {
              $outtable = "<p>Nessun corso disponibile </p>";
            } else {
              for ($i = 0; $i < count($corsi) - 1; $i++) {   //-1 perchè mi lascia l'ultimo campo a NULL
                $outtable .= "<tr>
            <th scope='row'>" . $corsi[$i]['id'] . "</th>
            <td>" . $corsi[$i]['nome'] . "</td>
            <td>" . $corsi[$i]['datainizio'] . "</td>
            <td>" . $corsi[$i]['datafine'] . "</td>
            <td>" . $corsi[$i]['docente'] . "</td>
            <th scope='col'><a href='modifica.php?id=" . $corsi[$i]['id'] . "&table=corsi' target='_blank' rel='noopener noreferrer'><i class='fa-solid fa-pencil'></i></a>
            <th scope='col'><a href='delete.php?id=" . $corsi[$i]['id'] . "&table=corsi' target='_blank' rel='noopener noreferrer'><i class='fa-solid fa-trash-can'></i></a>
            </tr>
