...
//VARIALIBI
$titolo = "Lista Eventi - Cyber Valley";
$table = "eventi"
?>
    ...
    <div class="main-panel">
      ...
      <div class="content">
        <button type="button" class="btn btn-warning btncrea">
          <a href="modifica.php?table=eventi" target='_blank' rel="noopener noreferrer">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            if (count($array) < 1) {
              ...
              for ($i = 0; $i < count($array) - 1; $i++) {   //-1 perchè mi lascia l'ultimo campo a NULL
                $outtable .= "<tr>
            <th scope='row'>" . $array[$i]['id'] . "</th>
            <td>" . $array[$i]['nome'] . "</td>
            <td>" . $array[$i]['dataevento'] . "</td>
            
            <th scope='col'><a href='modifica.php?id=" . $array[$i]['id'] . "&table=eventi' target='_blank' rel='noopener noreferrer'><i class='fa-solid fa-pencil'></i></a>
            <th scope='col'><a href='delete.php?id=" . $array[$i]['id'] . "&table=eventi' target='_blank' rel='noopener noreferrer'><i class='fa-solid fa-trash-can'></i></a>
            </tr>
